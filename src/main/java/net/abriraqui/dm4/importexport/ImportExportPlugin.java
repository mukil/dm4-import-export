...
public class ImportExportPlugin extends PluginActivator {
    ...
    /**
     * Generates a Firefox Bookmark Backup & Restore JSON document generated via the "Bookmark Manager" and
    ...
    /**
     * Understands and processes a HTML style bookmark export file generated by the "Bookmark Manager"
     * of Chromium 53.0.2785.x.
     * @param file
     * @return A JSON Object encoded as a plain text String containing two properties used by the dm4-webclient: "message" and "topic_id".
     */
    @POST
    ...
    /**
     * Understands and processes a HTML style report on a collection created with a german Zotero 4.0.29.18 version.
     * @param file
     * @return A JSON Object encoded as a plain text String containing two properties used by the dm4-webclient: "message" and "topic_id".
     */
    @POST
